...
if not exist version_ol.txt "X:\Program Files\Edgeless\EasyDown\aria2c.exe" --check-certificate=false -x16 -c -o "version_ol.txt" http://legacy.edgeless.top/api/v2/info/iso_version
...
:alpha
if not exist "X:\Program Files\Edgeless\system_update\version_ola.txt" "X:\Program Files\Edgeless\EasyDown\aria2c.exe" --check-certificate=false -x16 -c -o "version_ola.txt" http://legacy.edgeless.top/api/v2/alpha/version?token=そうだよ
...
if not exist "X:\Program Files\Edgeless\system_update\version_ol.txt" "X:\Program Files\Edgeless\EasyDown\aria2c.exe" --check-certificate=false -x16 -c -o "version_ol.txt" http://legacy.edgeless.top/api/v2/info/iso_version
